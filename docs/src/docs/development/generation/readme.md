...
<div class="git">Click <a href="https://raw.githubusercontent.com/oculusinfo/aperture-tiles/docs/src/img/tile-gen-process-lg.png">here</a> to view an expanded diagram</div>

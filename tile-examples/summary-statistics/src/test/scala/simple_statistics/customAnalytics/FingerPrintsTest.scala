//package simple_statistics.customAnalytics
//
//import org.scalatest.FunSuite
//import org.main.simple_statistics.customAnalytics.Fingerprints
//
//
//class FingerPrintsTest extends FunSuite{
//  
//  test("isHex"){
//    assert(Fingerprints.isHex("0") === true)  
//    assert(Fingerprints.isHex("AAA") === true)
//    assert(Fingerprints.isHex("aaa") === true) 
//    assert(Fingerprints.isHex("123") === true) 
//    assert(Fingerprints.isHex("-1") === true) 
//    assert(Fingerprints.isHex("-ab6F") === true) 
//    assert(Fingerprints.isHex("") === false) 
//    assert(Fingerprints.isHex("MHH") === false)
//    assert(Fingerprints.isHex("a45Y") === false) 
//  }
//  
//  test("greaterScore"){
//    assert(Fingerprints.scoreGreater("0",">5") === true) 
//    assert(Fingerprints.scoreGreater("6",">5") === true) 
//    assert(Fingerprints.scoreGreater("5",">5") === true) 
//    assert(Fingerprints.scoreGreater("-5",">5") === true) 
//    assert(Fingerprints.scoreGreater("a",">5") === true)
//    assert(Fingerprints.scoreGreater("0",">-5") === false) 
//    assert(Fingerprints.scoreGreater("6",">-5") === false) 
//    assert(Fingerprints.scoreGreater("5",">-5") === false) 
//    assert(Fingerprints.scoreGreater("-5",">-5") === false) 
//    assert(Fingerprints.scoreGreater("a",">-5") === false)
//    assert(Fingerprints.scoreGreater("a","a") === false)
//  }
//  
//  test("rangeScore"){
//    assert(Fingerprints.scoreGreater("0",">5") === true) 
